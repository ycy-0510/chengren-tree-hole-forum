    ...
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-emerald-100 via-teal-50 to-green-100">
        ...
        <div class="relative w-full max-w-md mx-4">
            ...
            <div class="text-center mb-8">
                <div class="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-emerald-100">
                <form @submit.prevent="login" class="space-y-6">
                    <div>
                        ...
                        <div class="relative">
                            <font-awesome-icon icon="fa-solid fa-user" class="absolute left-3 top-3 text-emerald-400" />
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <font-awesome-icon icon="fa-solid fa-lock" class="absolute left-3 top-3 text-emerald-400" />
